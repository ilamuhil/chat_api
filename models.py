...
from sqlalchemy import BigInteger, DateTime, ForeignKeyConstraint, Index, Integer, PrimaryKeyConstraint, String, Text, Uuid, text
...
class Documents(Base):
    ...
    chunck_index: Mapped[int] = mapped_column(Integer, nullable=False)
